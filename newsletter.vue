        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
        		<div class="site_container">
                    <div class="newsletter_container contact_container">
                        <div class="row">
                            <div class="col-md-6">
                                
                            </div>
                            <div class="col-md-6">
                                <form id="contact_form" class="form-horizontal" action="https://mobilefringe.createsend.com/t/d/s/bidirr/" method="post" @submit.prevent="validateBeforeSubmit">
                					...
                					<div class="form-group">
                                        <div class="col-xs-12">
                                            <button class="submit_btn animated_btn" type="submit" :disabled="formSuccess">{{$t("newsletter_page.subscribe")}}</button>
                                        </div>
                                    </div>
                                </form>
